...
const SUBJECTS: Subject[] = [
  { id: 'sub_math', name: 'Mathematics', short: 'Math', color: '#097FE8' },
  { id: 'sub_phy', name: 'Physics', short: 'Phy', color: '#9849E8' },
  { id: 'sub_chem', name: 'Chemistry', short: 'Chem', color: '#27918D' },
  { id: 'sub_bio', name: 'Biology', short: 'Bio', color: '#FF6D00' },
  { id: 'sub_eng', name: 'English', short: 'Eng', color: '#9C7054' },
  { id: 'sub_cs', name: 'Computer Science', short: 'CS', color: '#FFB110' },
  { id: 'sub_hindi', name: 'Hindi', short: 'Hindi', color: '#E0447A' },
  { id: 'sub_evs', name: 'Environmental Studies', short: 'EVS', color: '#5FA94F' },
  { id: 'sub_sci', name: 'Science', short: 'Sci', color: '#27918D' },
  { id: 'sub_sst', name: 'Social Studies', short: 'SST', color: '#8C5EC9' },
  { id: 'sub_his', name: 'History', short: 'His', color: '#B45309' },
  { id: 'sub_geo', name: 'Geography', short: 'Geo', color: '#0E9F8A' },
  { id: 'sub_civ', name: 'Civics', short: 'Civ', color: '#3B82F6' },
  { id: 'sub_sans', name: 'Sanskrit', short: 'San', color: '#D97706' },
  { id: 'sub_fren', name: 'French', short: 'Fr', color: '#6B7280' },
  { id: 'sub_ger', name: 'German', short: 'De', color: '#64748B' },
  { id: 'sub_span', name: 'Spanish', short: 'Es', color: '#CA8A04' },
  { id: 'sub_econ', name: 'Economics', short: 'Eco', color: '#065F46' },
  { id: 'sub_acc', name: 'Accountancy', short: 'Acc', color: '#1D4ED8' },
  { id: 'sub_bst', name: 'Business Studies', short: 'BSt', color: '#0F766E' },
  { id: 'sub_comm', name: 'Commerce', short: 'Com', color: '#334155' },
  { id: 'sub_pol', name: 'Political Science', short: 'Pol', color: '#7C3AED' },
  { id: 'sub_psy', name: 'Psychology', short: 'Psy', color: '#DB2777' },
  { id: 'sub_soc', name: 'Sociology', short: 'Soc', color: '#A16207' },
  { id: 'sub_ip', name: 'Informatics Practices', short: 'IP', color: '#2563EB' },
  { id: 'sub_pe', name: 'Physical Education', short: 'PE', color: '#EA580C' },
  { id: 'sub_art', name: 'Art & Craft', short: 'Art', color: '#C2410C' },
  { id: 'sub_music', name: 'Music', short: 'Mus', color: '#9D174D' },
  { id: 'sub_dance', name: 'Dance', short: 'Dan', color: '#BE185D' },
  { id: 'sub_drama', name: 'Drama', short: 'Dra', color: '#4C1D95' },
  { id: 'sub_gk', name: 'General Knowledge', short: 'GK', color: '#059669' },
  { id: 'sub_moral', name: 'Moral Science', short: 'Mor', color: '#0369A1' },
  { id: 'sub_robotics', name: 'Robotics', short: 'Rob', color: '#0EA5E9' },
  { id: 'sub_coding', name: 'Coding', short: 'Code', color: '#14B8A6' },
]
...
export function buildSeed(): DB {
  const db: DB = {
    ...
    calendarTasks: [], interventions: [], interventionResults: [], reports: [], insights: [],
  }
