...
export default function ParentTabs() {
  return (
    ...
    >
      ...
      <Tabs.Screen name="performance" options={{ title: 'Progress', tabBarIcon: ({ color, size }) => <Icon name="trend" size={size} color={color} /> }} />
      <Tabs.Screen name="calendar" options={{ title: 'Calendar', tabBarIcon: ({ color, size }) => <Icon name="calendar" size={size} color={color} /> }} />
      <Tabs.Screen name="ai" options={{ title: 'AI Insights', tabBarIcon: ({ color, size }) => <Icon name="sparkle" size={size} color={color} /> }} />
